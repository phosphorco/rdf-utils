...
(0, bun_test_1.describe)('GraphDB Integration Tests', function () {
    ...
    (0, bun_test_1.describe)('GraphDB-specific functionality', function () {
        ...
        (0, bun_test_1.test)('BUG: reasoning: false option should be respected for in-transaction queries', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, defaultGraph, _a, rdfs, rdf, ex, subClassOfQuad, typeQuad, entailedQuery_1, resultWithReasoningOutsideTx, resultWithoutReasoningOutsideTx, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        graph = new graphdb_js_1.GraphDBGraph(config, testGraphIri, true);
                    ...
                    case 5:
                        rdfs = 'http://www.w3.org/2000/01/rdf-schema#';
                        rdf = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#';
                        ex = 'http://example.org/reasoning-tx-bug/';
                        subClassOfQuad = rdf_js_1.factory.quad(rdf_js_1.factory.namedNode("".concat(ex, "Employee")), rdf_js_1.factory.namedNode("".concat(rdfs, "subClassOf")), rdf_js_1.factory.namedNode("".concat(ex, "Person")));
                        typeQuad = rdf_js_1.factory.quad(rdf_js_1.factory.namedNode("".concat(ex, "john")), rdf_js_1.factory.namedNode("".concat(rdf, "type")), rdf_js_1.factory.namedNode("".concat(ex, "Employee")));
                        return [4 /*yield*/, graph.add([subClassOfQuad, typeQuad])];
                    case 6:
                        _c.sent();
                        entailedQuery_1 = "\n          ASK WHERE {\n            <".concat(ex, "john> <").concat(rdf, "type> <").concat(ex, "Person> .\n          }\n        ");
                        return [4 /*yield*/, defaultGraph.ask(entailedQuery_1, { reasoning: true })];
                    case 7:
                        resultWithReasoningOutsideTx = _c.sent();
                        (0, bun_test_1.expect)(resultWithReasoningOutsideTx).toBe(true);
                        return [4 /*yield*/, defaultGraph.ask(entailedQuery_1, { reasoning: false })];
                    case 8:
                        resultWithoutReasoningOutsideTx = _c.sent();
                        (0, bun_test_1.expect)(resultWithoutReasoningOutsideTx).toBe(false);
                        // NOW: Test inside a transaction - this is where the bug manifests
                        return [4 /*yield*/, graph.inTransaction(function (txGraph) { return __awaiter(void 0, void 0, void 0, function () {
                                var txDefaultGraph, resultWithReasoningInTx, resultWithoutReasoningInTx;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            txDefaultGraph = txGraph.withIri(undefined);
                                            return [4 /*yield*/, txDefaultGraph.ask(entailedQuery_1, { reasoning: true })];
                                        case 1:
                                            resultWithReasoningInTx = _a.sent();
                                            (0, bun_test_1.expect)(resultWithReasoningInTx).toBe(true);
                                            return [4 /*yield*/, txDefaultGraph.ask(entailedQuery_1, { reasoning: false })];
                                        case 2:
                                            resultWithoutReasoningInTx = _a.sent();
                                            ...
                                            (0, bun_test_1.expect)(resultWithoutReasoningInTx).toBe(false);
                                            return [2 /*return*/];
                                    }
                                });
                            }); })];
    ...
    (0, bun_test_1.describe)('Triple Terms / RDF-star Support', function () {
        (0, bun_test_1.test)('should add quads with triple term subjects', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad, quads, _a, subject, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                    ...
                    case 2:
                        _c.trys.push([2, , 5, 9]);
                        innerTriple = rdf_js_1.factory.tripleTerm(EX.alice, EX.knows, EX.bob);
                        quad = rdf_js_1.factory.quad(innerTriple, EX.confidence, rdf_js_1.factory.literal('0.95', rdf_js_1.XSD.decimal));
                    ...
                    case 4:
                        ...
                        (0, bun_test_1.expect)(quads.length).toBe(1);
                        (0, bun_test_1.expect)(quads[0].subject.termType).toBe('Quad');
                        subject = quads[0].subject;
                        (0, bun_test_1.expect)(subject.subject.value).toBe('http://example.org/alice');
                        (0, bun_test_1.expect)(subject.predicate.value).toBe('http://example.org/knows');
                        (0, bun_test_1.expect)(subject.object.value).toBe('http://example.org/bob');
                        return [3 /*break*/, 9];
                    case 5:
                        _c.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, graph.deleteAll()];
        ...
        (0, bun_test_1.test)('should add multiple quads with same triple term subject', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad1, quad2, quad3, quads, _a, _i, quads_1, q, subject, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                    ...
                    case 2:
                        _c.trys.push([2, , 5, 9]);
                        innerTriple = rdf_js_1.factory.tripleTerm(EX.alice, EX.knows, EX.bob);
                        quad1 = rdf_js_1.factory.quad(innerTriple, EX.confidence, rdf_js_1.factory.literal('0.95', rdf_js_1.XSD.decimal));
                        quad2 = rdf_js_1.factory.quad(innerTriple, EX.source, EX.socialNetwork);
                        quad3 = rdf_js_1.factory.quad(innerTriple, EX.timestamp, rdf_js_1.factory.literal('2024-01-15', rdf_js_1.XSD.date));
                        return [4 /*yield*/, graph.add([quad1, quad2, quad3])];
                    case 3:
                        _c.sent();
                        _a = [[]];
                        return [4 /*yield*/, graph.quads()];
                    case 4:
                        quads = __spreadArray.apply(void 0, _a.concat([_c.sent(), true]));
                        (0, bun_test_1.expect)(quads.length).toBe(3);
                        // All should have the same triple term subject
                        for (_i = 0, quads_1 = quads; _i < quads_1.length; _i++) {
                            q = quads_1[_i];
                            (0, bun_test_1.expect)(q.subject.termType).toBe('Quad');
                            subject = q.subject;
                            (0, bun_test_1.expect)(subject.subject.value).toBe('http://example.org/alice');
                        }
                        return [3 /*break*/, 9];
        ...
        (0, bun_test_1.test)('should remove quads with triple term subjects', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad1, quad2, quads, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        quad1 = rdf_js_1.factory.quad(innerTriple, EX.confidence, rdf_js_1.factory.literal('0.95', rdf_js_1.XSD.decimal));
                        quad2 = rdf_js_1.factory.quad(innerTriple, EX.source, EX.socialNetwork);
                        return [4 /*yield*/, graph.add([quad1, quad2])];
                    case 3:
                        _d.sent();
                        _a = [[]];
                        return [4 /*yield*/, graph.quads()];
                    case 4:
                        quads = __spreadArray.apply(void 0, _a.concat([_d.sent(), true]));
                        (0, bun_test_1.expect)(quads.length).toBe(2);
                        // Remove one quad
                        return [4 /*yield*/, graph.remove([quad1])];
                    case 5:
                        // Remove one quad
                        _d.sent();
                        _b = [[]];
                        return [4 /*yield*/, graph.quads()];
                    case 6:
                        quads = __spreadArray.apply(void 0, _b.concat([_d.sent(), true]));
                        (0, bun_test_1.expect)(quads.length).toBe(1);
                        (0, bun_test_1.expect)(quads[0].predicate.value).toBe('http://example.org/source');
                        return [3 /*break*/, 11];
                    case 7:
                        _d.trys.push([7, 9, , 10]);
                        return [4 /*yield*/, graph.deleteAll()];
        ...
        (0, bun_test_1.test)('should preserve triple terms through transaction add/commit', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad_1, quads, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                    ...
                    case 2:
                        _c.trys.push([2, , 5, 9]);
                        innerTriple = rdf_js_1.factory.tripleTerm(EX.alice, EX.knows, EX.bob);
                        quad_1 = rdf_js_1.factory.quad(innerTriple, EX.confidence, rdf_js_1.factory.literal('0.95', rdf_js_1.XSD.decimal));
                        return [4 /*yield*/, graph.inTransaction(function (txGraph) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, txGraph.add([quad_1])];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
        ...
        (0, bun_test_1.test)('should rollback triple term quads on transaction failure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad_2, err_7, quads, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                    ...
                    case 2:
                        _c.trys.push([2, , 8, 12]);
                        innerTriple = rdf_js_1.factory.tripleTerm(EX.alice, EX.knows, EX.bob);
                        quad_2 = rdf_js_1.factory.quad(innerTriple, EX.confidence, rdf_js_1.factory.literal('0.95', rdf_js_1.XSD.decimal));
                        _c.label = 3;
                    case 3:
                        _c.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, graph.inTransaction(function (txGraph) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, txGraph.add([quad_2])];
                                        case 1:
                                            _a.sent();
                                            throw new Error('Deliberate failure');
                                    }
        ...
        (0, bun_test_1.test)('should query triple terms with SPARQL SELECT', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, defaultGraph, innerTriple, quad, results, bindings, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                        graph = _c.sent();
                        defaultGraph = new graphdb_js_1.GraphDBGraph(config, undefined, false);
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, , 5, 9]);
                        innerTriple = rdf_js_1.factory.tripleTerm(EX.alice, EX.knows, EX.bob);
                    ...
                    case 3:
                        _c.sent();
                        return [4 /*yield*/, graph.select("\n          PREFIX ex: <http://example.org/>\n          SELECT ?conf WHERE {\n            << ex:alice ex:knows ex:bob >> ex:confidence ?conf .\n          }\n        ")];
                    case 4:
                        results = _c.sent();
                        bindings = __spreadArray([], results, true);
                        (0, bun_test_1.expect)(bindings.length).toBe(1);
                        (0, bun_test_1.expect)((_b = bindings[0].get('conf')) === null || _b === void 0 ? void 0 : _b.value).toBe('0.95');
                        return [3 /*break*/, 9];
                    case 5:
                        _c.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, graph.deleteAll()];
        ...
        (0, bun_test_1.test)('should query triple terms with SPARQL ASK', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad, exists, notExists, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                    ...
                    case 5:
                        notExists = _b.sent();
                        (0, bun_test_1.expect)(notExists).toBe(false);
                        return [3 /*break*/, 10];
                    case 6:
                        _b.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, graph.deleteAll()];
        ...
        (0, bun_test_1.test)('should handle SPARQL CONSTRUCT with triple terms', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad, result, quads, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
                    ...
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, graph.construct("\n          PREFIX ex: <http://example.org/>\n          CONSTRUCT { ?s ?p ?o }\n          WHERE { ?s ?p ?o }\n        ")];
                    case 4:
                        result = _b.sent();
                        quads = __spreadArray([], result.quads(), true);
                        (0, bun_test_1.expect)(quads.length).toBe(1);
                        (0, bun_test_1.expect)(quads[0].subject.termType).toBe('Quad');
                        return [3 /*break*/, 9];
                    case 5:
        ...
        (0, bun_test_1.test)('should handle SPARQL UPDATE with triple terms (INSERT DATA)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, quads, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
        ...
        (0, bun_test_1.test)('should handle SPARQL UPDATE with triple terms (DELETE DATA)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, innerTriple, quad, quads, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    case 1:
        ...
        (0, bun_test_1.test)('real-world: annotating statements with provenance and confidence', function () { return __awaiter(void 0, void 0, void 0, function () {
            var graph, stmt1, stmt2, results, bindings, _a;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, createTestGraph(false)];
                    ...
                    case 2:
                        _d.trys.push([2, , 5, 9]);
                        stmt1 = rdf_js_1.factory.tripleTerm(EX.alice, EX.worksAt, EX.acmeCorp);
                        stmt2 = rdf_js_1.factory.tripleTerm(EX.bob, EX.worksAt, EX.acmeCorp);
                        // Add provenance and confidence annotations
                        return [4 /*yield*/, graph.add([
                                rdf_js_1.factory.quad(stmt1, EX.confidence, rdf_js_1.factory.literal('0.99', rdf_js_1.XSD.decimal)),
                                rdf_js_1.factory.quad(stmt1, EX.source, EX.hrDatabase),
                                rdf_js_1.factory.quad(stmt2, EX.confidence, rdf_js_1.factory.literal('0.75', rdf_js_1.XSD.decimal)),
                                rdf_js_1.factory.quad(stmt2, EX.source, EX.linkedIn),
                            ])];
                    case 3:
                        // Add provenance and confidence annotations
                        _d.sent();
                    ...
                    case 4:
                        ...
                        bindings = __spreadArray([], results, true);
                        (0, bun_test_1.expect)(bindings.length).toBe(1);
                        (0, bun_test_1.expect)((_b = bindings[0].get('person')) === null || _b === void 0 ? void 0 : _b.value).toBe('http://example.org/alice');
                        (0, bun_test_1.expect)((_c = bindings[0].get('conf')) === null || _c === void 0 ? void 0 : _c.value).toBe('0.99');
                        return [3 /*break*/, 9];
                    case 5:
                        _d.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, graph.deleteAll()];
